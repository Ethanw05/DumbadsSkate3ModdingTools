...
/// <summary>
/// RW-format constants shared between PS3 (.psg) and X360 (.rx2) Pegasus PSG output.
/// All values describe encoding conventions of the RenderWare arena/Pegasus binary
/// format itself, not any one console.
/// </summary>
public static class PegasusRwConstants
{
    /// <summary>
    ...
    /// <summary>
    /// Collision PSG type registry (64 types). Lists every RW type ID a collision-class
    /// PSG can carry. Includes all platform BaseResource IDs (0x00010030..0x00010034)
    /// so the same registry is reused for PS3 and X360 builds.
    /// </summary>
